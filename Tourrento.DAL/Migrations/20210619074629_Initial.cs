    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FELHASZNALÓ", "2631879b-6228-43bb-969a-4f40b8df81f3", "Felhasznaló", "FELHASZNALÓ" },
                    { "SZERVEZŐ", "547d8c4f-b4aa-4c6f-b8f8-902068c48a32", "Szervező", "SZERVEZŐ" },
                    { "ADMIN", "c52af7c7-f2ca-4c73-8e83-5e09747925e7", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "seedtwo", 0, "c205899b-3409-4c48-bb33-ea713f263d3d", "wincheszter@gmail.com", true, false, null, "Winch Eszter", "WINCHESZTER@GMAIL.COM", "WINCHESZTER", "AQAAAAEAACcQAAAAEIK3N8y2BVyx6T7lxRF4Y3Aq7UPAk2vRDl20u8U/EBdDk1CZfVmZJ+9Qdu6zM1Yj3A==", "06/30-152-5123", false, "009d7929-0ebd-405b-b701-3ef4b9399e21", false, "wincheszter" },
                    { "seedone", 0, "36585d9d-c4c2-4198-b5c7-87a16d26d9b4", "tesztelek@gmail.com", true, false, null, "Teszt Elek", "TESZTELEK@GMAIL.COM", "TESZTELEK", "AQAAAAEAACcQAAAAEJ3CmmiotK12ecaCKHgyiBsvpM+7NhoPCXT+vMrJx7kceGqdK/U++inoxdBH+x58lA==", "06/30-152-5123", false, "09b7798f-f38a-43ae-96ee-4d38ca568421", false, "tesztelek" },
                    { "seedthree", 0, "4f5a93a4-6eca-40a9-9056-58e68b541b0d", "kbela@gmail.com", true, false, null, "Kis Béla", "KBELA@GMAIL.COM", "KBELA", "AQAAAAEAACcQAAAAEAf4iiHXc52o5ldLYc8eqKW14kSHUxwNE77J6Oz1YOV95GbEnFv8tS3WHvqJhMLL1g==", "06/30-152-5123", false, "3ef5cc07-6941-4fda-984b-4a980578b420", false, "kbela" },
                    { "admin", 0, "d86cf38f-94c6-47cd-8633-8f89cf4b7339", "admin@tourrento.hu", true, false, null, "Admin", "ADMIN@TOURRENTO.HU", "ADMIN", "AQAAAAEAACcQAAAAEGXkdygXSIf/+LvAuKSnL450+/PMVcQ2CI8aVDI/cr6vKUsLygaRrsFbIqxuxUDaHw==", "06/30-152-5123", false, "65e20166-467d-490b-b257-c7cc96c56f90", false, "admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTimeOffset(new DateTime(2021, 6, 19, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(1444), new TimeSpan(0, 2, 0, 0, 0)), 2000, new DateTimeOffset(new DateTime(2021, 6, 20, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(1662), new TimeSpan(0, 2, 0, 0, 0)), "seedtwo" },
                    { 3, true, new DateTimeOffset(new DateTime(2021, 6, 19, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2260), new TimeSpan(0, 2, 0, 0, 0)), 1000, new DateTimeOffset(new DateTime(2021, 6, 20, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2263), new TimeSpan(0, 2, 0, 0, 0)), "seedtwo" },
                    { 4, true, new DateTimeOffset(new DateTime(2021, 6, 19, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2266), new TimeSpan(0, 2, 0, 0, 0)), 5000, new DateTimeOffset(new DateTime(2021, 6, 20, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2269), new TimeSpan(0, 2, 0, 0, 0)), "seedthree" },
                    { 2, true, new DateTimeOffset(new DateTime(2021, 6, 19, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2246), new TimeSpan(0, 2, 0, 0, 0)), 3000, new DateTimeOffset(new DateTime(2021, 6, 20, 9, 46, 29, 465, DateTimeKind.Unspecified).AddTicks(2256), new TimeSpan(0, 2, 0, 0, 0)), "seedthree" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "seedone", "A biciklizés során a fő célunk, hogy mindenki jól érezze magát. A túra során a pihenőkön közös programokat szervezünk, hogy a csapatot jobban összekovácsoljuk.", new DateTimeOffset(new DateTime(2021, 7, 23, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(4332), new TimeSpan(0, 2, 0, 0, 0)), "tour4.jpg", 12, "Hegyi biciklizés", 1800, new DateTimeOffset(new DateTime(2021, 7, 23, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(4326), new TimeSpan(0, 2, 0, 0, 0)), "Budapest", "Magyarország", "Mátyáshegyi út 57", 1037, "Budapest", "Magyarország", "Mátyáshegyi út 57", 1037 },
                    { 3, "seedone", "A több napos túra során rengeteg kalandban veszünk majd részt. Az étkezés és alvást a túra szervezői biztosítják.", new DateTimeOffset(new DateTime(2021, 8, 6, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(4148), new TimeSpan(0, 2, 0, 0, 0)), "tour3.jpg", 32, "Több napos túra", 42800, new DateTimeOffset(new DateTime(2021, 7, 27, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(4142), new TimeSpan(0, 2, 0, 0, 0)), "Budapest", "Magyarország", "Glück Frigyes út", 1025, "Budaörs", "Magyarország", "Mandula utca", 2040 },
                    { 1, "seedone", "Gyere el velünk a legjobb János-hegyi túrára! Ajánlott védőfelszerelés, mert a túra során mászásra is sor kerülhet.", new DateTimeOffset(new DateTime(2021, 7, 11, 9, 46, 29, 463, DateTimeKind.Unspecified).AddTicks(9969), new TimeSpan(0, 2, 0, 0, 0)), "tour1.jpg", 18, "János-hegyi túra", 2000, new DateTimeOffset(new DateTime(2021, 7, 10, 9, 46, 29, 462, DateTimeKind.Unspecified).AddTicks(3701), new TimeSpan(0, 2, 0, 0, 0)), "Budapest", "Magyarország", "Zugligeti út 110", 1121, "Budapest", "Magyarország", "Zugligeti út 110", 1121 },
                    { 2, "seedone", "Gyere el velünk a legjobb Gellért-hegyi túrára! Ajánlott védőfelszerelés, mert a túra során mászásra is sor kerülhet.", new DateTimeOffset(new DateTime(2021, 7, 22, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(3981), new TimeSpan(0, 2, 0, 0, 0)), "tour2.jpg", 30, "Gellért-hegyi túra", 1800, new DateTimeOffset(new DateTime(2021, 7, 22, 9, 46, 29, 464, DateTimeKind.Unspecified).AddTicks(3963), new TimeSpan(0, 2, 0, 0, 0)), "Budapest", "Magyarország", "Szent Gellért rkp. 16", 1013, "Budapest", "Magyarország", "Szent Gellért rkp. 16", 1013 }
                });
